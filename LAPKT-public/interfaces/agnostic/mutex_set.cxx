...
bool Mutex_Set::are_mutex(unsigned p, unsigned q) const
{
...
bool Mutex_Set::action_edeletes(const Action *a, unsigned p) const
{
	// 1. Action deletes p
...
void Mutex_Set::add(const Fluent_Vec &group)
{
...
void Mutex_Set::print(std::ostream &os) const
{
